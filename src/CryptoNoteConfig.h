...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(368934881474191040);
...
const char     CRYPTONOTE_NAME[]                             = "faboscoin";
...
const int      P2P_DEFAULT_PORT                              =  8088;
const int      RPC_DEFAULT_PORT                              =  8089;
...
const char* const SEED_NODES[] = { "209.250.254.179:8088", "52.30.175.117:8088" };
